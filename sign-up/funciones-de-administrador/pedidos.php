...
<body>
  ...
  <section class="home">
      ...
      <div class="container fondo">
        ...
        <div class="table-responsive">
          <table id="datos-Pedidos" class="table table-striped table-bordered">
            ...
            <?php
            if (isset($_POST['rechazar']) && isset($_POST['id'])) {
              $order_id = $_POST['id'];
              $user_email = $_SESSION['SESSION_EMAIL'];

              // Prepare the SQL statement to prevent SQL injection
              $stmt = $conn->prepare("UPDATE orders SET estado = 'rechazado' WHERE id = '$order_id'");
            ...
            if (isset($_POST['aprobar']) && isset($_POST['id'])) {
              ...
              // Prepare the SQL statement to prevent SQL injection
              $stmt = $conn->prepare("UPDATE orders SET estado = 'Aprobado' WHERE id = '$order_id'");
    ...
    <script type="text/javascript" src="../../js/responsive.bootstrap4.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        // Final scritp
        // $("td:contains('cancelado')").css("color", "red");
      })
    </script>
