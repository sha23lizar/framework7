    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/shallomcreativedesign2.0/Sign-up/change-password.php?reset='.$code.'">Cambiar contraseña</a></b>';
            ...
            echo "</div>";        
            $msg = "<div class='alert alert-info'>Hemos enviado un enlace de verificación a su dirección de correo electrónico.</div>";
        }
    } else {
        $msg = "<div class='alert alert-danger'>$email - Esta dirección de correo electrónico no se encuentra.</div>";
    }
}
?>
