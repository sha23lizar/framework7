  ...
  animation-delay: 0.9s;
   ...
   <body>
      <div class="container">
         ...
         <div class="text">
            Operacion realizada exitosamente, su cuenta ha sido registrada. Espere un momento
         </div>
      </div>
   </body>
</html>
...
<?php
    ...
    $urlRedireccion = isset($_GET['redirect']) ? $_GET['redirect'] : 'index.php'; // URL de redirección predeterminada
